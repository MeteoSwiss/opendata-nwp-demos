...
- [**05_interpolate_temp.ipynb**](05_interpolate_temp.ipynb) — Retrieve temperature forecast data as Xarray object and interpolate from model levels to standard pressure levels using [meteodata-lab](https://meteoswiss.github.io/meteodata-lab/).
