...
- [**09_constant_parameters.ipynb**](09_constant_parameters.ipynb) — Retrieve constants such as grid information, and verify that it matches with forecast parameters.
