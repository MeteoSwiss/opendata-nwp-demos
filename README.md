...
- [**02_download_soil_temp.ipynb**](02_download_soil_temp.ipynb) — Download forecast files to disk for offline storage, external tools, or advanced manual processing.[![launch - renku](https://renkulab.io/renku-badge.svg)](https://renkulab.io/sessions/user-anon-f0-c29d58eba9e5/lab/tree/opendata-nwp-demos/02_download_soil_temp.ipyng)
