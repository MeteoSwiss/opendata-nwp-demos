...
- [**03_calculate_wind_speed.ipynb**](03_calculate_wind_speed.ipynb) — Retrieve wind component forecasts as Xarray objects and derive the horizontal wind speed using the Python library [meteodata-lab](https://meteoswiss.github.io/meteodata-lab/). [![launch - renku](https://renkulab.io/renku-badge.svg)](https://renkulab.io/sessions/user-anon-f0-c29d58eba9e5/lab/tree/opendata-nwp-demos/03_calculate_wind_speed.ipynb)
- [**04_calculate_rel_humidity.ipynb**](04_calculate_rel_humidity.ipynb) — Retrieve specific humidity, temperature and pressure as Xarray objects and compute relative humidity. [![launch - renku](https://renkulab.io/renku-badge.svg)](https://renkulab.io/sessions/user-anon-f0-c29d58eba9e5/lab/tree/opendata-nwp-demos/04_calculate_rel_humidity.ipynb)
- [**05_interpolate_vertically.ipynb**](05_interpolate_vertically.ipynb) — Retrieve temperature forecasts as an Xarray object and perform two types of vertical interpolation: from model levels to pressure levels, and from model levels to a target altitude. [![launch - renku](https://renkulab.io/renku-badge.svg)](https://renkulab.io/sessions/user-anon-f0-c29d58eba9e5/lab/tree/opendata-nwp-demos/05_interpolate_vertically.ipynb)
- [**06_calculate_global_rad_flux.ipynb**](06_calculate_global_rad_flux.ipynb) — Retrieve direct and diffuse shortwave radiation fluxes from ICON-CH1-EPS forecasts and compute the **Global Radiation Flux** (`GLOB`) using [meteodata-lab](https://meteoswiss.github.io/meteodata-lab/). Includes a de-aggregation step to convert cumulative flux values into hourly averages. [![launch - renku](https://renkulab.io/renku-badge.svg)](https://renkulab.io/sessions/user-anon-f0-c29d58eba9e5/lab/tree/opendata-nwp-demos/06_calculate_global_rad_flux.ipynb)
- [**07_where_will_it_rain_next_24h.ipynb**](07_where_will_it_rain_next_24h.ipynb) — Visualize the probability of precipitation over Switzerland for the next 24 hours using ICON-CH1-EPS ensembles. [![launch - renku](https://renkulab.io/renku-badge.svg)](https://renkulab.io/sessions/user-anon-f0-c29d58eba9e5/lab/tree/opendata-nwp-demos/07_where_will_it_rain_next_24h.ipynb)
- [**08_where_will_the_sun_shine.ipynb**](08_where_will_the_sun_shine.ipynb) — Use ICON-CH2-EPS forecasts to map the probability of experiencing over 6 hours of sunshine on the **day after tomorrow**. [![launch - renku](https://renkulab.io/renku-badge.svg)](https://renkulab.io/sessions/user-anon-f0-c29d58eba9e5/lab/tree/opendata-nwp-demos/08_where_will_the_sun_shine.ipynb)
